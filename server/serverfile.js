...
app.post('/addtocart',function(req,res){
 ...
 app.post('/product',function(req,res){
    ...
    let result=fs.appendFileSync('./data/product.json', JSON.stringify(req.body),"utf8")
     fs.appendFileSync('./data/product.json', "\n","utf8")
     let resultdata=""
     if(!result){
         resultdata={success:true,message:"product insert successfully"}
     }
     else{
 ...
 app.post('/register',function(req,res){
   ...
   let result=fs.appendFileSync('./data/userinfo.json', JSON.stringify(req.body),"utf8")
    fs.appendFileSync('./data/userinfo.json', "\n","utf8")
    let resultdata=""
    if(!result){
 ...
 app.get('/productshow',function(req,res){
    let data=fs.readFileSync('./data/product.json',"utf8")
    let adddata=[]
    data.split('\n').forEach(d=>{
        adddata.push(d)
    })
